"""Phase 10.50 – ``domain:languages`` privacy policy declaration.
...
__all__ = ["build_languages_privacy_policy"]


def build_languages_privacy_policy() -> DomainPrivacyPolicy:
    """Declare the approved ``domain:languages`` privacy default.

    Languages declares a remote-allowed Domain default; remote processing is
    ...
    Memory consent and permissions remain separate canonical concerns.
    """
