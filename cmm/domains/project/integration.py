"""Phase 10.30 — Project Domain Integration.

Provides atomic, deterministic registration of the complete Project Domain
...
class ProjectDomainIntegrationResult:
    """Compact result container for a Project Domain registration."""
...
def _validate_no_duplicate_workflows(workflow_registry: Any, workflows: Any) -> None:
    ...
    existing_ids = {
        ...
        for definition in workflow_registry.list_for_domain(PROJECT_DOMAIN_ID)
    }
    duplicates = tuple(
...
def _rollback(
    ...
    *,
    ...
    if rollback_errors:
        ...
        raise DomainError(
            "Project Domain registration failed and rollback was incomplete: "
...
def register_project_domain(
    *,
    ...
    """Register the complete Project Domain atomically."""
    ...
    operations = build_project_operation_definitions()
    workflows = build_project_workflow_definitions()
    permission_policy = build_project_permission_policy()
    ...
    return ProjectDomainIntegrationResult(
        definition=definition,
        profile=profile,
        resources=resources,
        rules=rules,
