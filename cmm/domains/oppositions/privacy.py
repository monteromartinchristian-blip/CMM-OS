"""Phase 10.50 – ``domain:oppositions`` privacy policy declaration.
...
__all__ = ["build_oppositions_privacy_policy"]


def build_oppositions_privacy_policy() -> DomainPrivacyPolicy:
    """Declare the approved ``domain:oppositions`` privacy default.

    Oppositions declares a remote-allowed Domain default; remote processing is
