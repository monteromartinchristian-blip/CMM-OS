...
def build_initial_permission_catalog() -> tuple[DomainPermissionPolicy, ...]:
    return (
        DomainPermissionPolicy(
            ...
            allowed_resource_kinds=("internal",),
        ...
        DomainPermissionPolicy(
            ...
            allowed_resource_kinds=("clinical", "internal"),
            allowed_sensitivity_levels=("internal", "confidential"),
            allow_memory_read=True,
        ...
        DomainPermissionPolicy(
            ...
            allowed_resource_kinds=("internal", "academic"),
            allow_memory_read=True,
            autonomy_limits=DomainAutonomyLimits(maximum_autonomy_level=1),
        ),
        DomainPermissionPolicy(
            ...
            allowed_resource_kinds=("internal", "reflection"),
            allow_memory_read=True,
            allow_sensitive_inference=True,
        ...
        DomainPermissionPolicy(
            ...
            allowed_resource_kinds=("internal", "repository"),
            allow_memory_read=True,
            approval_requirements=("file.modify",),
            autonomy_limits=DomainAutonomyLimits(
                maximum_autonomy_level=2, allow_reversible_changes=True
            ),
        ),
    )
