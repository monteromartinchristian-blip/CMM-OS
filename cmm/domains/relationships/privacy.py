"""Phase 10.50 – ``domain:relationships`` privacy policy declaration.
...
__all__ = ["build_relationships_privacy_policy"]


def build_relationships_privacy_policy() -> DomainPrivacyPolicy:
    """Declare the approved ``domain:relationships`` privacy default.

    Relationships content is local-only by default and remains subject to
    canonical most-restrictive composition: resource and package privacy may only
    make the effective result stricter.
    """
