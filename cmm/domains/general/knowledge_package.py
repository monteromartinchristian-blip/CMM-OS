"""Phase 10.49 – ``domain:general`` knowledge package schema.
...
__all__ = ["build_general_knowledge_package_schema"]


def build_general_knowledge_package_schema() -> DomainKnowledgePackageSchema:
    """Declare the approved ``domain:general`` knowledge package schema."""
    return DomainKnowledgePackageSchema(
        id="knowledge-package-schema:general",
