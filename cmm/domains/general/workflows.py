...
def _decision_support() -> DomainWorkflowDefinition:
    return DomainWorkflowDefinition(
        ...
        nodes=(
            ...
            _node(
                "search",
                WorkflowNodeType.SEARCH_KNOWLEDGE,
                "SearchKnowledge",
                dependencies=("load",),
            ),
            _node(
            ...
            _node(
                ...
                "CompareItems",
                dependencies=("reason",),
                operation_id="general.compare_items",
            ),
            _node(
                "gaps",
            ...
            _node(
                ...
                "PrepareQuestions",
                dependencies=("gaps",),
                operation_id="general.prepare_questions",
            ),
            _node(
                "report",
                WorkflowNodeType.EXECUTE_OPERATION,
                ...
                operation_id="general.generate_report",
            ),
            _node(
                "complete",
    ...
    return DomainWorkflowDefinition(
        ...
        nodes=(
            ...
            _node(
                "reason",
                WorkflowNodeType.REASON,
                "ApplyGoalClarificationRule",
                dependencies=("profile",),
            ),
            _node(
                "ask",
                WorkflowNodeType.ASK_QUESTION,
                "AskBlockingQuestions",
                dependencies=("reason",),
                wait_condition={"kind": "user_response"},
            ),
            _node(
                "pause",
                WorkflowNodeType.PAUSE,
                "PauseWhenUnanswered",
                dependencies=("ask",),
            ),
            _node(
    ...
    return DomainWorkflowDefinition(
        ...
        nodes=(
            ...
            _node(
                ...
                "CreateSummary",
                dependencies=("gaps",),
                operation_id="general.create_summary",
            ),
            _node(
                "questions",
                WorkflowNodeType.EXECUTE_OPERATION,
    ...
    return DomainWorkflowDefinition(
        ...
        nodes=(
            ...
            _node(
                ...
                "BuildTimeline",
                dependencies=("reason",),
                operation_id="general.build_timeline",
            ),
            _node(
                "gaps",
                WorkflowNodeType.DETECT_GAPS,
