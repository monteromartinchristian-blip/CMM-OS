...
_OUTPUT_SCHEMAS: dict[str, dict] = {
    "concerns.understand_concern": _schema(
        ("understood",),
        {
            ...
            "core_issue": {"type": ["string", "null"]},
            "ask_question": {"type": "boolean"},
            "mandatory_action_plan": {"type": "boolean"},
            "advice_generated": {"type": "boolean"},
        },
    ),
    "concerns.infer_support_need": _schema(
        ("support_need",),
        {
            ...
            "problem_solving_allowed": {"type": "boolean"},
        },
    ),
    "concerns.map_lived_experience": _schema(
        ("emotions",),
    ...
    "concerns.separate_reality_interpretation": _schema(
        ("statements",),
        {"statements": _RECORDS, "promotions_blocked_total": {"type": "integer"}},
    ),
    ...
    "concerns.calibrate_uncertainty": _schema(
        ("calibrations",),
        {"calibrations": _RECORDS, "resolved_by_invention": {"type": "boolean"}},
    ),
    "concerns.evaluate_reassurance": _schema(
        ("assessment",), {"reassurance": _REASSURANCE_PAYLOAD}
    ),
    "concerns.evaluate_risk": _schema(
        ("risk_level",),
        {
            ...
            "emotion_drove_risk": {"type": "boolean"},
            "specialized_ownership_preserved": {"type": "boolean"},
            "escalation_recommended": {"type": "boolean"},
        },
    ),
    "concerns.identify_open_questions": _schema(
        ("questions",),
        {"questions": _RECORDS, "ritual_questions_suppressed": {"type": "integer"}},
    ),
    "concerns.explore_options": _schema(
        ("options",),
        {"options": _RECORDS, "decision_adopted": {"type": "boolean"}},
    ),
    "concerns.prepare_next_step": _schema(
        ("next_step", "no_next_step_required"),
        {
            "next_step": {"type": ["object", "null"]},
            "no_next_step_required": {"type": "boolean"},
    ...
    "concerns.review_recurring_concern": _schema(
        ("recurrence",),
        {
            ...
            "pathology_inferred": {"type": "boolean"},
            "psychiatric_label": {"type": "boolean"},
            "diagnosis": {"type": ["string", "null"]},
            "reassurance_allowed": {"type": "boolean"},
    ...
    "concerns.prepare_professional_discussion": _schema(
        ("prepared_content",),
        {
            ...
            "external_transmission_performed": {"type": "boolean"},
            "appointment_booked": {"type": "boolean"},
            "contact_performed": {"type": "boolean"},
        },
    ),
}
