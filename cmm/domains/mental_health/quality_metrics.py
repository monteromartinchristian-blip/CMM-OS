...
def build_mental_health_quality_metrics() -> tuple[DomainQualityMetric, ...]:
    ...
    return (
        ...
        DomainQualityMetric(
            id="quality-metric:mental-health:health-authority-boundary-fidelity",
            domain_id=domain_id,
            schema_version="1",
            version="1",
            name="health-authority-boundary-fidelity",
            weight=Decimal("0.20"),
            evaluator_id="evaluator:health-authority-boundary-fidelity",
        ...
        DomainQualityMetric(
            id="quality-metric:mental-health:sensitive-memory-proposal-discipline",
            domain_id=domain_id,
            schema_version="1",
            version="1",
            name="sensitive-memory-proposal-discipline",
            weight=Decimal("0.10"),
            evaluator_id="evaluator:sensitive-memory-proposal-discipline",
            minimum_score=Decimal("1.00"),
            blocking=True,
        ),
        DomainQualityMetric(
            id="quality-metric:mental-health:non-pathologizing-behavior",
            domain_id=domain_id,
            schema_version="1",
            version="1",
            name="non-pathologizing-behavior",
            weight=Decimal("0.05"),
            evaluator_id="evaluator:non-pathologizing-behavior",
