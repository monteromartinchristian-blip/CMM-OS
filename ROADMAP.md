...
> **Implemented:** Phases 0–9 plus Phase 10 through **10.47**<br>
> **Implemented and audited:** Phases 0–9 plus Phase 10 through **10.46**<br>
...
> **Phase 10.47:** `PHASE10_47=DOCS_ONLY_REMEDIATION_V2_IMPLEMENTED_PENDING_REAUDIT_V5`; independent Re-audit **V5** pending; `INDEPENDENT_AUDIT_V1=FAIL`; `INDEPENDENT_REAUDIT_V2=FAIL`; `INDEPENDENT_REAUDIT_V3=FAIL`; `INDEPENDENT_REAUDIT_V4=FAIL`; `BLOCKERS=0`; `MAJORS=0`; `MINORS=1_REMEDIATED_PENDING_INDEPENDENT_VERIFICATION`; `MINOR_01=REMEDIATED_PENDING_INDEPENDENT_VERIFICATION`; `MAJOR_01=VERIFIED_REMEDIATED`; `MAJOR_02=VERIFIED_REMEDIATED`; `MAJOR_03=VERIFIED_REMEDIATED`; `MAJOR_04=WITHDRAWN_FALSE_POSITIVE`; `DP-047=VERIFIED_EXISTING`; `AT-DP-047=PASS`; `CLOSURE_ELIGIBLE=NO`<br>
> **Next action:** Phase 10.47 documentation-only remediation V2 awaits independent Re-audit V5; Phase 10.48 has not started<br>
...
**Implemented and audited through:** **Phase 10.46 — Domain Model Policies** (Independent Re-audit **V2** `PASS`; historical V1 `FAIL` preserved; `BLOCKERS=0`; `MAJORS=0`; `MINORS=0`; `DP-046=VERIFIED_EXISTING`; `AT-DP-046=PASS`; `CLOSURE_ELIGIBLE=YES`; audited implementation HEAD `f62069cf935fff5bbac6055e5a63d9b0302993a6`; bundle SHA-256 `8a7b57f88880092946038a236d3c802f1ea14e7b06e54150fe34928d11686e0a`; final audit report `docs/audits/phase-10.46-independent-reaudit-v2.md`; complete, independently audited and closed).
...
**Next action:** Phase 10.47 documentation-only remediation V2 is implemented and awaits independent Re-audit V5; Phase 10.48 has not started.
**Phase 10.47 — Domain Benchmark Suites:** implementation independently verified; audit history preserved through Independent Re-audit V4: V1 `FAIL`, V2 `FAIL`, V3 `FAIL`, V4 `FAIL`; V3 independently verified all implementation findings while V4 confirmed the remaining documentation MINOR was only partially remediated. Portable, model-agnostic benchmark assets (`DomainBenchmarkSuite` / `DomainBenchmarkCase`) owned by `DomainDefinition.benchmark_suites`; `benchmark_suites` travels through the canonical declarative Domain Pack parser/loader path; deterministic canonical JSON export and SHA-256 content digest keyed to numeric `maximum_cost_eur`; benchmark schema validation is separated from metadata model/provider authority validation; twelve first-party Domain Packs expose representative suites; no benchmark runtime, registry, model/provider authority, evaluator execution or Phase 10.48 quality metrics; `PHASE10_47=DOCS_ONLY_REMEDIATION_V2_IMPLEMENTED_PENDING_REAUDIT_V5`; `BLOCKERS=0`; `MAJORS=0`; `MINORS=1_REMEDIATED_PENDING_INDEPENDENT_VERIFICATION`; `MINOR_01=REMEDIATED_PENDING_INDEPENDENT_VERIFICATION`; `MAJOR_01=VERIFIED_REMEDIATED`; `MAJOR_02=VERIFIED_REMEDIATED`; `MAJOR_03=VERIFIED_REMEDIATED`; `MAJOR_04=WITHDRAWN_FALSE_POSITIVE`; `DP-047=VERIFIED_EXISTING`; `AT-DP-047=PASS`; `CLOSURE_ELIGIBLE=NO`; `PHASE10_48=NOT_STARTED`; reference `docs/reference/domain-benchmark-suites.md`; audit reports `docs/audits/phase-10.47-independent-audit-v1.md`, `docs/audits/phase-10.47-independent-reaudit-v2.md`, `docs/audits/phase-10.47-independent-reaudit-v3.md`, and `docs/audits/phase-10.47-independent-reaudit-v4.md`.
...
The current published release is `v0.8.0`. The independently audited closure baseline covers Phases 0–9 plus Phase 10 through **10.46**. **Phase 10.46 — Domain Model Policies** is complete, independently re-audited and closed after Independent Re-audit **V2** `PASS` with `BLOCKERS=0`, `MAJORS=0`, `MINORS=0`, `DP-046=VERIFIED_EXISTING`, `AT-DP-046=PASS`, `CLOSURE_ELIGIBLE=YES`, audited implementation HEAD `f62069cf935fff5bbac6055e5a63d9b0302993a6`, and bundle SHA-256 `8a7b57f88880092946038a236d3c802f1ea14e7b06e54150fe34928d11686e0a`. Phases 10.52–10.53 remain the final planned Domain Packs.
