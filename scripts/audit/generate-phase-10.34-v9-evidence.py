#!/usr/bin/env python3
"""Generate deterministic Phase 10.34 V9 source, node, and gate evidence."""
...
SOURCE_MANIFEST = EVIDENCE_DIR / "phase-10.34-v9-source-hashes.json"
NODE_INVENTORY = EVIDENCE_DIR / "phase-10.34-v9-pytest-nodes.txt"
GATES = EVIDENCE_DIR / "phase-10.34-v9-gates.json"
...
def main() -> int:
    ...
    _write_json(
        GATES,
        {
            ...
            "pytest_evidence": {
                "inventory": "docs/audits/evidence/phase-10.34-v9-pytest-nodes.txt",
            ...
            "source_evidence": {
                "file_count": len(files),
                "manifest": "docs/audits/evidence/phase-10.34-v9-source-hashes.json",
