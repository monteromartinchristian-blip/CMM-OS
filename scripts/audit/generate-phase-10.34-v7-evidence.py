#!/usr/bin/env python3
"""Generate deterministic Phase 10.34 V7 source, node, and gate evidence."""
...
SOURCE_MANIFEST = EVIDENCE_DIR / "phase-10.34-v7-source-hashes.json"
NODE_INVENTORY = EVIDENCE_DIR / "phase-10.34-v7-pytest-nodes.txt"
GATES = EVIDENCE_DIR / "phase-10.34-v7-gates.json"
...
def main() -> int:
    ...
    quality_scope = (
        ...
        "tests/domains/domain_session_audit_evidence.py scripts/audit/*.py"
    )
    gate_map = {
        "focused_tests": _gate(
            "focused_tests",
    ...
    _write_json(
        GATES,
        {
            ...
            "pytest_evidence": {
                "inventory": "docs/audits/evidence/phase-10.34-v7-pytest-nodes.txt",
            ...
            "source_evidence": {
                "file_count": len(files),
                "manifest": "docs/audits/evidence/phase-10.34-v7-source-hashes.json",
