"""Tests for Phase 10.21 Relationships Domain atomic rollback after
...
def _assert_no_relationships_entries(registries):
    assert registries["domain_registry"].get(RELATIONSHIPS_DOMAIN_ID) is None
...
def test_failure_after_definition_rolls_back():
    ...
    _assert_no_relationships_entries(registries)
