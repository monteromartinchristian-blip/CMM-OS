...
def test_first_party_schema_modules_are_declarative_only() -> None:
    ...
    The twelve Phase 10.49 modules plus the Phase 10.52 ``mental_health`` and
    Phase 10.53 ``neurodivergence`` modules, which follow the same declarative
    convention.
    """
    assert len(FIRST_PARTY_SCHEMA_MODULES) == 14
