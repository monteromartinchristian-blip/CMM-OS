...
| `DP-029` | Life Plan: dependencies, scenarios, resources, decision states, cross-domain impact, and plan drift. | `SRC-P04:P04-C01` | 10.29 | shared domain infrastructure; `cmm/domains/life_plan/` — implementation candidate complete, awaiting independent audit; canonical design `docs/superpowers/specs/2026-08-26-life-plan-domain-design.md`; implementation reference `docs/reference/life-plan-domain.md` | `REQUIRES_PHASE_INSPECTION` | `AT-DP-029` |
