...
| `DP-028` | Sport: training load, recovery, injury signals, authorized health constraints, and return-to-training workflow. | `SRC-P02:P02-C05` | 10.28 | shared domain infrastructure; `cmm/domains/sport/` — complete; remediation plan `docs/superpowers/plans/2026-08-25-sport-domain-audit-v1-remediation.md`; audit V1 `docs/audits/phase-10.28-sport-independent-audit-v1.md`; implementation reference `docs/reference/sport-domain.md` | `REQUIRES_PHASE_INSPECTION` | `AT-DP-028` — `candidate PASS` (connected 44-checkpoint acceptance; audit V1 findings remediated; re-audit pending) |
