...
| `DP-023` | Oppositions: versioned strategy, official-source verification, milestones, constraints, trade-offs, and study planning. | `SRC-P08:P08-C01` | 10.23 | shared domain infrastructure; `cmm/domains/oppositions/` — implemented, pending final independent closure audit; external sources deferred | `VERIFIED_EXISTING` | `AT-DP-023` |
