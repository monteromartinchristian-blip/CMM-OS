...
| `DP-028` | Sport: training load, recovery, injury signals, authorized health constraints, and return-to-training workflow. | `SRC-P02:P02-C05` | 10.28 | shared domain infrastructure; `cmm/domains/sport/` — complete; final remediation plan `docs/superpowers/plans/2026-08-25-sport-domain-audit-v4-final-remediation.md`; re-audit V4 `docs/audits/phase-10.28-sport-independent-reaudit-v4.md`; implementation reference `docs/reference/sport-domain.md` | `REQUIRES_PHASE_INSPECTION` | `AT-DP-028` — `candidate PASS` (connected 44-checkpoint acceptance; final closure remediation complete; final independent re-audit pending) |
