...
| `DP-028` | Sport: training load, recovery, injury signals, authorized health constraints, and return-to-training workflow. | `SRC-P02:P02-C05` | 10.28 | shared domain infrastructure; `cmm/domains/sport/` — complete; canonical plan `docs/superpowers/plans/2026-08-25-sport-domain-implementation.md`; implementation reference `docs/reference/sport-domain.md` | `VERIFIED_EXISTING` | `AT-DP-028` — `PASS` (connected 44-checkpoint acceptance; implementation complete; pending independent audit) |
