...
| `DP-026` | Languages: multi-language tutoring with consented onboarding and longitudinal tracking; evidence-typed certified, estimated, and observed proficiency by skill; valid language-variety handling; adaptive lessons, exercises, conversation, roleplay, writing and speaking review; evidence-backed error patterns and progression; spaced review; temporally verified certification preparation; and purpose-minimized cross-domain composition. | `SRC-P05:P05-C03` | 10.26 | shared domain infrastructure; `cmm/domains/languages/` — first independent audit `FAIL` (2 blockers, 5 majors); candidate remediation implemented; canonical design `docs/superpowers/specs/2026-08-23-languages-domain-design.md`; remediation plan `docs/superpowers/plans/2026-08-23-languages-domain-audit-remediation.md`; implementation reference `docs/reference/languages-domain.md` | `REQUIRES_PHASE_INSPECTION` | `AT-DP-026` — `PASS` (remediated connected candidate acceptance; independent re-audit pending) |
