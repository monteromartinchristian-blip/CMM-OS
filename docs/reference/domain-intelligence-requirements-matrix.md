...
| `DP-030` | Project: generic project resources, milestones, dependencies, status, operations, and workflows, plus conditional software development capabilities. | `SRC-R10:R10-C30` | 10.30 | shared domain infrastructure; `cmm/domains/project/` — candidate implementation has Targeted M2 Remediation V3 implemented; canonical design `docs/superpowers/specs/2026-08-26-project-domain-design.md`; implementation reference `docs/reference/project-domain.md`; Audit V1 = `FAIL` recorded; Re-audit V2 = `FAIL` recorded; Re-audit V3 = `FAIL` recorded; Targeted M2 Remediation V3 = implemented/candidate; Re-audit V4 = pending | `REQUIRES_PHASE_INSPECTION` | `AT-DP-030` — `PASS` (56 connected checkpoints; 34-class adversarial closure gate; independent re-audit V4 pending) |
