...
| `DP-028` | Sport: training load, recovery, injury signals, authorized health constraints, and return-to-training workflow. | `SRC-P02:P02-C05` | 10.28 | shared domain infrastructure; `cmm/domains/sport/` — complete; remediation plan V2 `docs/superpowers/plans/2026-08-25-sport-domain-audit-v2-remediation.md`; re-audit V2 `docs/audits/phase-10.28-sport-independent-reaudit-v2.md`; implementation reference `docs/reference/sport-domain.md` | `REQUIRES_PHASE_INSPECTION` | `AT-DP-028` — `candidate PASS` (connected 44-checkpoint acceptance; audit V2 findings remediated; re-audit pending) |
