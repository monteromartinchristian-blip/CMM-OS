...
| `DP-026` | Languages: multi-language tutoring with consented onboarding and longitudinal tracking; evidence-typed certified, estimated, and observed proficiency by skill; valid language-variety handling; adaptive lessons, exercises, conversation, roleplay, writing and speaking review; evidence-backed error patterns and progression; spaced review; temporally verified certification preparation; and purpose-minimized cross-domain composition. | `SRC-P05:P05-C03` | 10.26 | shared domain infrastructure; `cmm/domains/languages/` — complete and independently audited; final independent closure audit: PASS; BLOCKERS=0; MAJORS=0; MINORS=0; canonical design `docs/superpowers/specs/2026-08-23-languages-domain-design.md`; V2 remediation plan `docs/superpowers/plans/2026-08-23-languages-domain-v2-remediation.md`; implementation reference `docs/reference/languages-domain.md` | `VERIFIED_EXISTING` | `AT-DP-026` — `PASS` (connected acceptance; independently audited; final closure gate `PASS`) |
...
| `DP-030` | Project: generic project resources, milestones, dependencies, status, operations, and workflows, plus conditional software development capabilities. | `SRC-R10:R10-C30` | 10.30 | shared domain infrastructure; `cmm/domains/project/` — candidate implementation has Targeted Trace Authority Binding Remediation V5 implemented; canonical design `docs/superpowers/specs/2026-08-26-project-domain-design.md`; implementation reference `docs/reference/project-domain.md`; Audit V1 = `FAIL` recorded; Re-audit V2 = `FAIL` recorded; Re-audit V3 = `FAIL` recorded; Re-audit V4 = `FAIL` recorded; Re-audit V5 = `FAIL` recorded; Targeted Trace Authority Binding Remediation V5 = implemented/candidate; Re-audit V6 = pending | `REQUIRES_PHASE_INSPECTION` | `AT-DP-030` — `PASS` (56 connected checkpoints; 34-class adversarial closure gate; independent re-audit V6 pending) |
