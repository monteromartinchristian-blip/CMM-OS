...
| `DP-026` | Languages: multi-language tutoring with consented onboarding and longitudinal tracking; evidence-typed certified, estimated, and observed proficiency by skill; valid language-variety handling; adaptive lessons, exercises, conversation, roleplay, writing and speaking review; evidence-backed error patterns and progression; spaced review; temporally verified certification preparation; and purpose-minimized cross-domain composition. | `SRC-P05:P05-C03` | 10.26 | shared domain infrastructure; `cmm/domains/languages/` — independent re-audit V2 `FAIL`; V2 findings remediated (`2 BLOCKER + 3 MAJOR`); independent V3 audit `PENDING`; canonical design `docs/superpowers/specs/2026-08-23-languages-domain-design.md`; V2 remediation plan `docs/superpowers/plans/2026-08-23-languages-domain-v2-remediation.md`; implementation reference `docs/reference/languages-domain.md` | `REQUIRES_PHASE_INSPECTION` | `AT-DP-026` — `PASS` (connected V2-remediation candidate; independent V3 audit pending) |
